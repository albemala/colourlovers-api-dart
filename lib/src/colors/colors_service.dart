...
abstract class ColorsService extends ChopperService {
  ...
  @GET(path: '/random')
  Future<Response<ColourloversColor>> getRandomColor(@Query() String format);
}
...
Response<ColourloversColor> _convertResponseObject(Response<dynamic> response) {
  return convertResponseFirstObject(response, ColourloversColor.fromJson);
}

Response<List<ColourloversColor>> _convertResponseList(
  Response<dynamic> response,
) {
  return convertResponseList(response, ColourloversColor.fromJson);
}
